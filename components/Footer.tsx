    ...
    <footer className="bg-brand-darkGreen text-white">
      <div className="container-custom section-padding">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-white/80 mb-4 max-w-md">
              Soluciones prácticas, eficientes y modernas en servicios transaccionales.
              Ser referentes en Colombia en recaudos, pagos y logística.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="#beneficios" className="text-white/80 hover:text-white transition-colors">
                  Beneficios
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="#comisiones" className="text-white/80 hover:text-white transition-colors">
                  Comisiones
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-white/80">
              <li className="flex items-start space-x-2">
                ...
                <a href="https://wa.me/573246830038" className="hover:text-white transition-colors">
                  +57 324 683 0038
                </a>
              </li>
              <li className="flex items-start space-x-2">
        ...
        <div className="border-t border-white/20 mt-8 pt-8 text-center text-white/60">
          <p>&copy; {new Date().getFullYear()} TuColpagos Colombia SAS. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  )
